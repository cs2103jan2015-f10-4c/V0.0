...
#ifndef WWDATEPARSER_H
#define WWDATEPARSER_H

#include <string>
#include <vector>
#include "WWDateChecker.h"

//WWDateParser will attempt to parse the dates found in a string using regex.
...
//WWDateParser will only retain at most 2 important dates found using the precedence rule desribed above.
//The rest of the parsed dates which are not included will be treated as task name.
//WWDateParser will return a vector of at most size 2.
