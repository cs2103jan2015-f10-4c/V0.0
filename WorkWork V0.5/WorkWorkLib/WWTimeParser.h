...
#ifndef WWTIMEPARSER_H
#define WWTIMEPARSER_H

#include <string>
#include <vector>

//WWTimeParser will attempt to parse the time found in a string using regex.
...
//WWTimeParser will only retain at most 2 important time found using the precedence rule desribed above.
//The rest of the parsed time which are not included will be treated as task name.
//WWTimeParser will return a vector of at most size 2.
